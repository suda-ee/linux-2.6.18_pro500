...
/** This is an internal structure used to maintain the SGDMA list */
	typedef struct {
		...
		u32 RunState;
		       /**< Flag to indicate SGDMA is started */
		u32 Separation;
 ...
 */
	typedef struct XDmaV3 {
		u32 RegBase;
			   /**< Base address of channel registers */
		u32 IsReady;
			   /**< Flag to indicate device is ready to use */
		XDmaV3_BdRing BdRing;
			       /**< BD storage for SGDMA */
	} XDmaV3;
 ...
 */
	XStatus XDmaV3_Initialize(XDmaV3 * InstancePtr, u32 BaseAddress);
 ...
 */
	XStatus XDmaV3_SimpleTransfer(XDmaV3 * InstancePtr, XDmaBdV3 * Bdptr);

/*
 * Scatter gather DMA related functions in xdmav3_sg.c
 */
	XStatus XDmaV3_SgStart(XDmaV3 * InstancePtr);
	void XDmaV3_SgStop(XDmaV3 * InstancePtr);
	XStatus XDmaV3_SgSetPktThreshold(XDmaV3 * InstancePtr, u16 Threshold);
	XStatus XDmaV3_SgSetPktWaitbound(XDmaV3 * InstancePtr, u16 TimerVal);
	u16 XDmaV3_SgGetPktThreshold(XDmaV3 * InstancePtr);
	u16 XDmaV3_SgGetPktWaitbound(XDmaV3 * InstancePtr);

	XStatus XDmaV3_SgListCreate(XDmaV3 * InstancePtr, u32 PhysAddr,
				    u32 VirtAddr, u32 Alignment,
				    unsigned BdCount);
	XStatus XDmaV3_SgListClone(XDmaV3 * InstancePtr, XDmaBdV3 * SrcBdPtr);
	XStatus XDmaV3_SgCheck(XDmaV3 * InstancePtr);
	XStatus XDmaV3_SgBdAlloc(XDmaV3 * InstancePtr, unsigned NumBd,
				 XDmaBdV3 ** BdSetPtr);
	XStatus XDmaV3_SgBdUnAlloc(XDmaV3 * InstancePtr, unsigned NumBd,
				   XDmaBdV3 * BdSetPtr);
	XStatus XDmaV3_SgBdToHw(XDmaV3 * InstancePtr, unsigned NumBd,
				XDmaBdV3 * BdSetPtr);
	XStatus XDmaV3_SgBdFree(XDmaV3 * InstancePtr, unsigned NumBd,
				XDmaBdV3 * BdSetPtr);
 ...
 */
	XStatus XDmaV3_SelfTest(XDmaV3 * InstancePtr);
