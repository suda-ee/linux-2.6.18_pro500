 ...
 *
 */
	typedef void (*XTemac_FifoSendHandler) (void *CallBackRef,
						unsigned StatusCnt);
 ...
 *
 */
	typedef void (*XTemac_ErrorHandler) (void *CallBackRef,
					     XStatus ErrorClass, u32 ErrorWord1,
					     u32 ErrorWord2);
/*@}*/
 ...
 */
	typedef struct {
		u32 TxDmaErrors;
			 /**< Number of Tx DMA errors detected */
		u32 TxPktFifoErrors;
		...
		u32 RxDmaErrors;
			 /**< Number of Rx DMA errors detected */
		u32 RxPktFifoErrors;
			 /**< Number of Rx packet FIFO errors detected */

		u32 FifoErrors;
			 /**< Number of length/status FIFO errors detected */
		u32 IpifErrors;
			 /**< Number of IPIF transaction and data phase errors
                                  detected */
		u32 Interrupts;
 ...
 */
	typedef struct {
		...
		u8 TxDre;
			/**< Has data realignment engine on Tx channel */
		u8 RxDre;
			/**< Has data realignment engine on Rx channel */
		u8 TxCsum;
			/**< Has checksum offload on Tx channel */
		u8 RxCsum;
			/**< Has checksum offload on Tx channel */
		u8 PhyType;
			/**< Which type of PHY interface is used (MII,
                                 GMII, RGMII, ect. */
	} XTemac_Config;
 ...
 */
	typedef struct XTemac_PacketFifo {
		...
		/* Function used to transfer data between
		   FIFO and a buffer */
		 XStatus(*XferFn) (struct XTemac_PacketFifo * Fptr,
				   void *BufPtr, u32 ByteCount, int Eop);
	} XTemac_PacketFifo;
 ...
 */
	XStatus XTemac_CfgInitialize(XTemac * InstancePtr,
 ...
 */
	XStatus XTemac_FifoWrite(XTemac * InstancePtr, void *BufPtr,
	...
	XStatus XTemac_FifoRead(XTemac * InstancePtr, void *BufPtr,
				u32 ByteCount, int Eop);
 ...
 */
	...
	XStatus XTemac_SgUnAlloc(XTemac * InstancePtr, u32 Direction,
				 unsigned NumBd, XDmaBdV3 * BdPtr);
 ...
 */
	...
	XStatus XTemac_SetMacPauseAddress(XTemac * InstancePtr,
					  void *AddressPtr);
	...
	XStatus XTemac_MulticastAdd(XTemac * InstancePtr, void *AddressPtr,
				    int Entry);
	void XTemac_MulticastGet(XTemac * InstancePtr, void *AddressPtr,
				 int Entry);
 ...
 */
	void XTemac_GetSoftStats(XTemac * InstancePtr,
				 XTemac_SoftStats * StatsPtr);
