 ...
 */
	XStatus XIic_DynMasterRecv(XIic * InstancePtr, u8 * RxMsgPtr,
				   u8 ByteCount);
	XStatus XIic_DynMasterSend(XIic * InstancePtr, u8 * TxMsgPtr,
				   u8 ByteCount);

/*
 * Dynamic IIC Core Initialization.
 */
	XStatus XIic_DynamicInitialize(XIic * InstancePtr);
