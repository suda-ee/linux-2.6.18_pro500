/* $Id: pro_powerpc_drivers_xilinx_xpacket_fifo.patch,v 1.1.2.1 2008/03/02 19:46:54 kiryukhin Exp $ */
/******************************************************************************
*
...
*
******************************************************************************/
XStatus XPacketFifoV200a_L0Read(u32 RegBaseAddress, u32 DataBaseAddress,
				u8 * BufferPtr, u32 ByteCount)
{
	u32 Width;
